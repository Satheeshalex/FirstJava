...
<div class="jumbotron text-center">
  <div class="container">
    ...
    <h1>Getting Started with Dev OpsHeroku</h1>
    <p>This is a sample Java application deployed to Heroku, a good foundation for understanding how to get the most out of the DevOps in Heroku platform.</p>
      </div>
</div>
<div class="container">
